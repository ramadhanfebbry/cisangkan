...
class Pengumuman extends Dashboard_Controller
{
    ...
    public function index($offset = 0)
    {
        ...
        if ($pengumuman) {
            ...
            $this->data['paging'] = $this->pengumuman->paging('biasa', site_url('dashboard/pengumuman/halaman/'), 4);
        } else {
    ...
    public function detail($slug = '')
    {
        ...
        if ($pengumuman) {
            ...
            $this->data['pengumuman'] = 'Pengumuman dengan judul yang dimaksud tidak ada.'. anchor('dashboard/pengumuman', ' Kembali ke halaman pengumuman.', 'class="alert-link"');
        }
