...
//Pustakawan I 
$route['pwn_1/regis/halaman/(:num)'] = "pwn_1/regis/index/$1";
$route['pwn_1/regis/cari/(:num)'] = "pwn_1/regis/index/$1";
$route['pwn_1/regis/error'] = "pwn_1/regis/error";
$route['pwn_1/regis/sukses'] = "pwn_1/regis/sukses";
$route['pwn_1/regis-download_form-error'] = 'pwn_1/regis/error';
$route['pwn_1/transaksi/halaman/(:num)'] = "pwn_1/transaksi/index/$1";
